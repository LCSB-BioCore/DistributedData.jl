...
- index of the column in the `columns` array (i.e. a number from
  `1:length(columns)`)
"""
function dapply_cols(dInfo::Dinfo, fn, columns::Vector{Int})
...
"""
function dapply_rows(dInfo::Dinfo, fn)
...
"""
function dcount(ncats::Int, dInfo::Dinfo)::Vector{Int}
    tabulate = (d) -> begin
...
"""
function dscale(dInfo::Dinfo, columns::Vector{Int})
